...
import org.uet.bpmnchecker.views.diagrams.objectdiagram.NewObjectDiagram;
import org.uet.bpmnchecker.views.diagrams.objectdiagram.ObjDiagramOptions;
import org.uet.bpmnchecker.views.diagrams.objectdiagram.QualifierInputView;
...
public class NewObjectDiagramView extends JPanel 
  implements View, PrintableView, SortChangeListener {
    ...
    private final List<String> errorObjects = new ArrayList<String>();
    ...
    public NewObjectDiagramView(MainWindow mainWindow, MSystem system, List<String> errObjs) {
    	fMainWindow = mainWindow;
        fSystem = system;
        ...
        initDiagram(false, null, errObjs);
    }

    public void initDiagram(boolean loadDefaultLayout, DiagramOptions fOpt) {
    	if (fOpt == null)
			fObjectDiagram = new NewObjectDiagram( this, fMainWindow.logWriter());
		else
			fObjectDiagram = new NewObjectDiagram( this, fMainWindow.logWriter(), new ObjDiagramOptions(fOpt));
    ...
    public void initDiagram(boolean loadDefaultLayout, DiagramOptions fOpt, List<String> errObjs) {
    	if (fOpt == null)
			fObjectDiagram = new NewObjectDiagram(this, fMainWindow.logWriter(), errObjs);
		else
			fObjectDiagram = new NewObjectDiagram(this, fMainWindow.logWriter(), new ObjDiagramOptions(fOpt), errObjs);
