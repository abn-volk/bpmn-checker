...
package org.uet.bpmnchecker.views.diagrams.objectdiagram;
...
import org.uet.bpmnchecker.util.PersistHelper;
...
import org.uet.bpmnchecker.views.diagrams.DiagramViewWithObjectNode;
import org.uet.bpmnchecker.views.diagrams.elements.AssociationName;
import org.uet.bpmnchecker.views.diagrams.elements.DiamondNode;
import org.uet.bpmnchecker.views.diagrams.elements.PlaceableNode;
import org.uet.bpmnchecker.views.diagrams.elements.edges.AssociationOrLinkPartEdge;
import org.uet.bpmnchecker.views.diagrams.elements.edges.BinaryAssociationClassOrObject;
import org.uet.bpmnchecker.views.diagrams.elements.edges.BinaryAssociationOrLinkEdge;
import org.uet.bpmnchecker.views.diagrams.elements.edges.EdgeBase;
import org.uet.bpmnchecker.views.diagrams.elements.edges.LinkEdge;
import org.uet.bpmnchecker.views.diagrams.elements.edges.NAryAssociationClassOrObjectEdge;
import org.uet.bpmnchecker.views.diagrams.event.ActionLoadLayout;
import org.uet.bpmnchecker.views.diagrams.event.ActionSaveLayout;
import org.uet.bpmnchecker.views.diagrams.event.DiagramInputHandling;
import org.uet.bpmnchecker.views.diagrams.objectdiagram.NewObjectDiagramView;
import org.uet.bpmnchecker.views.diagrams.objectdiagram.ObjDiagramOptions;
import org.uet.bpmnchecker.views.diagrams.objectdiagram.ObjectNode;
import org.uet.bpmnchecker.views.selection.objectselection.ObjectSelection;
...
public class NewObjectDiagram extends DiagramViewWithObjectNode 
	...
	private List<String> errorObjects = new ArrayList<String>();
     ...
     */
    NewObjectDiagram(NewObjectDiagramView newObjectDiagramView, PrintWriter log) {
    	this(newObjectDiagramView, log, new ObjDiagramOptions());
    }

    NewObjectDiagram(NewObjectDiagramView newObjectDiagramView, PrintWriter log, ObjDiagramOptions options) {
    	super(options, log);
    ...
    NewObjectDiagram(NewObjectDiagramView newObjectDiagramView, PrintWriter log, List<String> errObjs) {
    	this(newObjectDiagramView, log, new ObjDiagramOptions());
    	errorObjects = errObjs;
    }
    
    NewObjectDiagram(NewObjectDiagramView newObjectDiagramView, PrintWriter log, ObjDiagramOptions options, List<String> errObjs) {
    	this(newObjectDiagramView, log, options);
    	errorObjects = errObjs;
    }
    @Override
    ...
    public void addObject(MObject obj) {
    	...
    	if (errorObjects.contains(obj.name()))
    		n.setError(true);
			...
			try {
				while(ap.evalXPath() != -1) {
					...
					if (obj != null) {
						...
						if (errorObjects.contains(node.name())) node.setError(true);
